...
void hmc5883l_init() {
	...
	I2cSendByte(HMC5883L_ADDR, HMC5883L_CONFREGB, regValue);
	I2cSendByte(HMC5883L_ADDR, HMC5883L_MODEREG, HMC5883L_MEASUREMODE);
}
...
void hmc5883l_getrawdata(int16_t *mxraw, int16_t *myraw, int16_t *mzraw) {
	...
	I2cRead(HMC5883L_ADDR, HMC5883L_DATAREGBEGIN, buff, 6);
